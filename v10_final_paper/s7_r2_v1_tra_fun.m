function [ F ] = s7_r2_v1_tra_fun( x, b, a )
N = 0;
...
source_expect = b/a*[0.412371134020619,0.523668793258658,1.29336313402062,0.600000000000000,0,1.25802714609582,0,1.51770177319588,0,0.549461773195876,0,0,0.600000000000000,0]';
% source_expect = [0.824742268041237,0.275631000000013,0,0,0,0.314230000000019,0,0,0,0.679056533803223,0,0,0.638599000000006,0]';% situation 1 
...
F6 = source_expect(6) - load_expect(6) + x(6)*(x(24)-x(25)-x(26)-x(27));%节点6非标准电压，非平衡节
