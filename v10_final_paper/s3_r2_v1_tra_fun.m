function [ F ] = s3_r2_v1_tra_fun( x, b,a )
N = 0;
...
load_expect = b*0.1*[0 2.07 4.14 1.03 2.07 3.10 1.55 5.17 4.65 0.62 1.03 1.03 1.03 2.17]';
source_expect =[0,0,0,0,0,1.23336127008571,0,0.600000000000000,0,0.600000000000000,0,0,0,0]';
