...
%         [ data, data_I_real{n(k)}, data_U_real{n(k)}, P_load_real{n(k)}, P_out_real{n(k)}] = Limited_ShortestPath_loss(Connect, data_I_expect{n(k)}, data_U_expect{n(k)}, P_load_real{n(k)}, P_demand, destination, U_rated, source, source_expect(:,n(k)), Capacity_line, R, P_out_real{n(k)}, eff );
...
%         destination = m(k);
%         P_demand = -compare_load(m(k),n(k));
%         [ data, data_I_real{n(k)}, data_U_real{n(k)}, P_load_real{n(k)}, P_out_real{n(k)}] = Limited_LongestPath_loss(Connect, data_I_expect{n(k)}, data_U_expect{n(k)}, P_load_real{n(k)}, P_demand, destination, U_rated, source, source_expect(:,n(k)), Capacity_line, R, P_out_real{n(k)}, eff );
