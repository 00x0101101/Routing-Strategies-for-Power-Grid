function [ data, Status_after, status_after, source_status_after ] = SourceLimited_Mapcal( Map, source, destination, Status_before, Capacity, demand, source_status_before, source_Cap, R )
    Map_temp = Map;
    demand_temp = demand;
    ...
    while flag
        ...
        b = source_Cap(source_temp(sa)) - source_status_temp1(source_temp(sa));
        if b>=0
