...
load_expect = 2*[0	2.070721847	4.141443694	1.035360924	2.070721847	3.106082771	1.553041385	5.176804618	4.659124156	0.621216554	1.035360924	1.035360924	1.035360924	2.174257939]';
% load_expect = [0 2 4 1 2 3 1 5 4 1 1 1 1 2]';
% load_expect = [2 3 4 5 6 7 6 5 4 3 2 1 6 4]';
% load_expect = [0.8 1 2.3 3.2 2 1 0.7 0.4 2.3 1.5 2.1 1.6 2.8 0.9]';    %capline = 0.8 传统出现供不上的情况
% source_expect = [10 10 10 6 0 10 0 10 0 6 0 0 6 0]'; % MW
source_expect = 1.5*[5 5 5 3 0 5 0 5 0 3 0 0 3 0]';
% source_expect = [0 0 0 0 0 35 0 0 0 0 0 0 0 0]';
% source_expect = [20 20 0 0 0 5 0 0 0 0 0 0 0 0]';
