function [data, Status_after, status_after ] = multisource_singledestination( Map, source, destination, Status_before, Capacity, demand )
    Map_temp = Map;
    demand_temp = demand;
    ...
    while flag
        ...
        for t=1:1:length(source)
            [ distance_temp1, route_temp ] = singlesource_singledestination( Map_temp, source(t), destination );
        ...
        [ distance_temp, route_temp ] = singlesource_singledestination( Map_temp, source(index), destination );
